...
const DEFAULT_DATA = {
  ...
  special: [
    ...
    { name: "Märkätilojen vesieristys (urakka)",             qty: 25,  unit: "m²", unitPrice: 65,    plan: "C", note: "KH, Pesuhuone, Sauna, WC:t, Kodinhoito (lattia + seinien alaosat)" },
    { name: "Märkätilojen väliseinien purku",                qty: 45,  unit: "m²", unitPrice: 35,    plan: "C", note: "Ennen kosteudenkestävää gyproc-uusintaa" },
